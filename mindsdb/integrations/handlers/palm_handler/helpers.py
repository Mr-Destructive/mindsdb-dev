...
def retry_with_exponential_backoff(
    ...
    def _retry_with_exponential_backoff(func):
        """
        Exponential backoff to retry requests on a rate-limited API call, as recommended by palm.
        ...
        https://github.com/palm/palm-cookbook/blob/main/examples/How_to_handle_rate_limits.ipynb
        """  # noqa
...
def count_tokens(messages, encoder, model_name='gpt-3.5-turbo-0301'):
    """ Original token count implementation can be found in the palm cookbook. """
